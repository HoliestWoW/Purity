...
-- Append the difficulty coefficient(s) to the description text
local goldColor = "|cffffd100"
local whiteColor = "|cffffffff"
local coefficientText = ""

	if challengeData.specializations then
		-- Handle challenges with multiple specs (e.g., Tome of Purity, The Ascetic's Path)
		...
		for _, specData in ipairs(challengeData.specializations) do
			...
			else -- Logic for other spec-based challenges like Tome of Purity
	...
	elseif Purity.ChallengeCoefficients[challengeData.challengeName] then
		-- Handle standard challenges with a single coefficient
